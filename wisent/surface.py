...
wisent-tools is an operational package whose public contract is the set of
runners and registered names callers can address. Current source may expose
Python modules; published versions also shipped shell runners, plugin entry
points, and explicit exports, so the reader retains all four surface kinds when
recovering an older sdist:
